/*demanar precisió i el número d'iteracions màximes, en cas de que no convergeixi.

i1: calcular dos trapezis i una extrapolacio
i2: calcular 3 trap i 2 extrap.
...
*/
